...
def writeVirtualRDF(virtual_list, virtual_tuples, output_file) :
    for item in virtual_list :
        ...
        output_file.write("\n\t" + kb + "nanoPub-" + item[column_ind][2:])
        output_file.write("\n\t\trdf:type np:Nanopublication")
        output_file.write(" ;\n\t\tnp:hasAssertion " + kb + "assertion-" + item[column_ind][2:])
        output_file.write(" ;\n\t\tnp:hasProvenance " + kb + "provenance-" + item[column_ind][2:])
        output_file.write(" ;\n\t\tnp:hasPublicationInfo " + kb + "pubInfo-" + item[column_ind][2:])
        output_file.write(" .\n}\n\n")
        # Nanopublication assertion
        output_file.write(kb + "assertion-" + item[column_ind][2:] + " { ")
        output_file.write("\n\t" + kb + item[column_ind][2:] + " a owl:Class ")
        ...
        output_file.write("\n\t" + kb + "assertion-" + item[column_ind][2:])
        ...
        output_file.write(" .\n}\n\n")
        # Nanopublication publication info
        output_file.write(kb + "pubInfo-" + item[column_ind][2:] + " {")
        output_file.write("\n\t" + kb + "nanoPub-" + item[column_ind][2:])
        output_file.write("\n\t\tprov:generatedAtTime \"" + "{:4d}-{:02d}-{:02d}".format(datetime.utcnow().year,datetime.utcnow().month,datetime.utcnow().day) + "T" + "{:02d}:{:02d}:{:02d}".format(datetime.utcnow().hour,datetime.utcnow().minute,datetime.utcnow().second) + "Z\"^^xsd:dateTime ")
        output_file.write(" .\n}\n\n")
...
def writeActualRDF(actual_list, actual_tuples, output_file) :
    for item in actual_list :
        actual_tuple = {}
        # Nanopublication head
        output_file.write(kb + "head-" + item[column_ind].replace(" ","_") + " {")
        output_file.write("\n\t" + kb + "nanoPub-" + item[column_ind].replace(" ","_"))
        output_file.write("\n\t\trdf:type np:Nanopublication")
        output_file.write(" ;\n\t\tnp:hasAssertion " + kb + "assertion-" + item[column_ind].replace(" ","_"))
        output_file.write(" ;\n\t\tnp:hasProvenance " + kb + "provenance-" + item[column_ind].replace(" ","_"))
        output_file.write(" ;\n\t\tnp:hasPublicationInfo " + kb + "pubInfo-" + item[column_ind].replace(" ","_"))
        output_file.write(" .\n}\n\n")
        # Nanopublication assertion
        output_file.write(kb + "assertion-" + item[column_ind].replace(" ","_") + " { ")
        output_file.write("\n\t" + kb + item[column_ind].replace(" ","_") + " a owl:Class ")
        ...
        output_file.write(" .\n}\n\n")
        # Nanopublication provenance
        output_file.write(kb + "provenance-" + item[column_ind].replace(" ","_") + " {")
        output_file.write("\n\t" + kb + "assertion-" + item[column_ind].replace(" ","_"))
        output_file.write("\n\t\tprov:generatedAtTime \"" + "{:4d}-{:02d}-{:02d}".format(datetime.utcnow().year,datetime.utcnow().month,datetime.utcnow().day) + "T" + "{:02d}:{:02d}:{:02d}".format(datetime.utcnow().hour,datetime.utcnow().minute,datetime.utcnow().second) + "Z\"^^xsd:dateTime ")
        if (derived_from_ind is not None) and (item[derived_from_ind] != "") :
            output_file.write(" ;\n\t\tprov:wasDerivedFrom " + convertVirtualToKGEntry(item[derived_from_ind]))
        ...
        output_file.write(" .\n}\n\n")
        # Nanopublication publication info
        output_file.write(kb + "pubInfo-" + item[column_ind].replace(" ","_") + " {")
        output_file.write("\n\t" + kb + "nanoPub-" + item[column_ind].replace(" ","_"))
        output_file.write("\n\t\tprov:generatedAtTime \"" + "{:4d}-{:02d}-{:02d}".format(datetime.utcnow().year,datetime.utcnow().month,datetime.utcnow().day) + "T" + "{:02d}:{:02d}:{:02d}".format(datetime.utcnow().hour,datetime.utcnow().minute,datetime.utcnow().second) + "Z\"^^xsd:dateTime ")
        output_file.write(" .\n}\n\n")
        ...
        for v_tuple in virtual_tuples :
            if (v_tuple["Column"] == v_column) :
                if "Study" in v_tuple :
                    ...
                    # Nanopublication head
                    output_file.write(kb + "head-" + v_tuple["Column"][2:] + "-" + index + " { ")
                    output_file.write("\n\t" + kb + "nanoPub-" + v_tuple["Column"][2:] + "-" + index)
                    output_file.write("\n\t\trdf:type np:Nanopublication")
                    output_file.write(" ;\n\t\tnp:hasAssertion " + kb + "assertion-" + v_tuple["Column"][2:] + "-" + index)
                    output_file.write(" ;\n\t\tnp:hasProvenance " + kb + "provenance-" + v_tuple["Column"][2:] + "-" + index)
                    output_file.write(" ;\n\t\tnp:hasPublicationInfo " + kb + "pubInfo-" + v_tuple["Column"][2:] + "-" + index)
                    output_file.write(" .\n}\n\n")
                    # Nanopublication assertion
                    output_file.write(kb + "assertion-" + v_tuple["Column"][2:] + "-" + index + " {")
                    output_file.write("\n\t" + kb + v_tuple["Column"][2:] + "-" + index + " a " + kb + v_tuple["Column"][2:])
                    ...
                    output_file.write(" .\n}\n\n")
                    # Nanopublication provenance
                    output_file.write(kb + "provenance-" + v_tuple["Column"][2:] + "-" + index + " { ")
                    output_file.write("\n\t" + kb + "assertion-" + v_tuple["Column"][2:] + "-" + index)
                    output_file.write("\n\t\tprov:generatedAtTime \"" + "{:4d}-{:02d}-{:02d}".format(datetime.utcnow().year,datetime.utcnow().month,datetime.utcnow().day) + "T" + "{:02d}:{:02d}:{:02d}".format(datetime.utcnow().hour,datetime.utcnow().minute,datetime.utcnow().second) + "Z\"^^xsd:dateTime ")
                    ...
                    output_file.write(" .\n}\n\n")
                    # Nanopublication publication info
                    output_file.write(kb + "pubInfo-" + v_tuple["Column"][2:] + "-" + index + " {")
                    output_file.write("\n\t" + kb + "nanoPub-" + v_tuple["Column"][2:] + "-" + index)
                    output_file.write("\n\t\tprov:generatedAtTime \"" + "{:4d}-{:02d}-{:02d}".format(datetime.utcnow().year,datetime.utcnow().month,datetime.utcnow().day) + "T" + "{:02d}:{:02d}:{:02d}".format(datetime.utcnow().hour,datetime.utcnow().minute,datetime.utcnow().second) + "Z\"^^xsd:dateTime ")
                    output_file.write(" .\n}\n\n")
                ...
                try :
                    ...
                    for a_tuple in actual_tuples :
                        ...
                        if (a_tuple["Column"] in data_key ) :
                            try :
                                # Nanopublication head
                                output_file.write(kb + "head-" + a_tuple["Column"].replace(" ","_") + "-" + row[id_index] + " {")
                                output_file.write("\n\t" + kb + "nanoPub-" + a_tuple["Column"].replace(" ","_") + "-" + row[id_index])
                                output_file.write("\n\t\trdf:type np:Nanopublication")
                                output_file.write(" ;\n\t\tnp:hasAssertion " + kb + "assertion-" + a_tuple["Column"].replace(" ","_") + "-" + row[id_index])
                                output_file.write(" ;\n\t\tnp:hasProvenance " + kb + "provenance-" + a_tuple["Column"].replace(" ","_") + "-" + row[id_index])
                                output_file.write(" ;\n\t\tnp:hasPublicationInfo " + kb + "pubInfo-" + a_tuple["Column"].replace(" ","_") + "-" + row[id_index])
                                output_file.write(" .\n}\n\n")
                                # Nanopublication assertion
                                output_file.write(kb + "assertion-" + a_tuple["Column"].replace(" ","_") + "-" + row[id_index] + " {")
                                output_file.write("\n\t" + kb + a_tuple["Column"].replace(" ","_") + "-" + row[id_index] + " a " + a_tuple["Attribute"])
                                ...
                                # provenance columns moved down to provenance block of nanopublication
                                ...
                                output_file.write(" .\n}\n\n")
                                # Nanopublication provenance
                                output_file.write(kb + "provenance-" + a_tuple["Column"].replace(" ","_") + "-" + row[id_index] + " {")
                                output_file.write("\n\t" + kb + "assertion-" + a_tuple["Column"].replace(" ","_") + "-" + row[id_index])
                                output_file.write("\n\t\tprov:generatedAtTime \"" + "{:4d}-{:02d}-{:02d}".format(datetime.utcnow().year,datetime.utcnow().month,datetime.utcnow().day) + "T" + "{:02d}:{:02d}:{:02d}".format(datetime.utcnow().hour,datetime.utcnow().minute,datetime.utcnow().second) + "Z\"^^xsd:dateTime ")
                                if "wasDerivedFrom" in a_tuple :
                                    output_file.write(" ;\n\t\tprov:wasDerivedFrom " + convertVirtualToKGEntry(a_tuple["wasDerivedFrom"], row[id_index]))
                                    if checkVirtual(a_tuple["wasDerivedFrom"]) :
                                ...
                                output_file.write(" .\n}\n\n")
                                # Nanopublication publication info
                                output_file.write(kb + "pubInfo-" + a_tuple["Column"].replace(" ","_") + "-" + row[id_index] + " {")
                                output_file.write("\n\t" + kb + "nanoPub-" + a_tuple["Column"].replace(" ","_") + "-" + row[id_index])
                                output_file.write("\n\t\tprov:generatedAtTime \"" + "{:4d}-{:02d}-{:02d}".format(datetime.utcnow().year,datetime.utcnow().month,datetime.utcnow().day) + "T" + "{:02d}:{:02d}:{:02d}".format(datetime.utcnow().hour,datetime.utcnow().minute,datetime.utcnow().second) + "Z\"^^xsd:dateTime ")
                                output_file.write(" .\n}\n\n")
